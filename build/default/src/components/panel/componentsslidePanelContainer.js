...
var container=".slide-container",btnleft=".slide-button.left",btnright=".slide-button.right",items=".slide-items",slides="ul",slide="li",ctrlnav=".slide-controls",ii,cntli,delta,altura;//***********************************************
ns.slidePanelContainer=function(){return function(options){this.init(options);this.config={};(function(config){config.container=config.container||".slide-container";config.btnleft=config.btnleft||".slide-button.left";config.btnright=config.btnright||".slide-button.right";config.items=config.items||".slide-items";config.slides=config.slides||"ul";config.slide=config.slide||"li";config.slide=config.ctrlnav=".slide-controls"})(this.config);console.log(config)}}();ns.slidePanelContainer.prototype=new ns.container;//*******************************************************
//*************************************************
