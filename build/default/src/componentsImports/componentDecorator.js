import{util}from"./util01.js";import{components}from"component";export const Component=function(options){return function(target){//console.log("estoy dentro de target");
//console.dir(target);
...
var targetInstance=new target,container=new components.container;util.extend(container,targetInstance);//console.dir(targetInstance) 
targetInstance.init(options);if("initevent"in targetInstance){}//console.log("estoy dentro de target initevent")
