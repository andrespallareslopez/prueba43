import{util}from"./util01.js";import{components}from"./components01.js";var controls;;(function(ns,util,components){"use strict";ns.panelScroll=function(){return function(options){(function(options){//ejemplo para guia, como ejemplo, no borrar, dejar el comentario 
...
// }
//*******************************************************************
})(controls||(controls={}),util,components);export{controls};util.addNameSpace(window.controls,controls);